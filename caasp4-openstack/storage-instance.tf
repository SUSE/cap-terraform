# NFS storage addon file for caasp4 terraform based deployments
#
# This terraform file adds a machine to the caasp4 network running a nfs server,
# sharing /srv/nfs/kubedata with the proper permissions. # This nfs share can
# then be consumed by nfs provisoener within caasp4.
#
